...
class _UserHomeScreenState extends State<UserHomeScreen> {
  ...
  void initState() {
    super.initState();
    userSetupCompleted = UserAccount.accountCompleted(); ///Calls Future for later usage, prevents unnecessary reloads
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: BasicPage(
        ...
        appBar: AppBar(//uses custom AppBar to load userdata
          centerTitle: true,
          title: FutureBuilder(
            future: getUserCreds,
            builder: (context, AsyncSnapshot snapshot) {
              if(snapshot.hasData){
                ...
                return Text("Welcome"); //shows default text if there are issues with the user
              }
          }),
        ),
        body: FutureBuilder(
          future: userSetupCompleted, //Checks if the user has his finished profile creation
